...
const populations = [10, 1340, 542, 80];
...
//   language: "English",
//   population: "140",
//   neighbours: ["Myanmar", "Nepal", "Bhutan"],
// };
...
/* LECTURE: Dot vs. Bracket Notation
  ...
  console: 'Finland has 6 billion finnish-speaking people, 3 neighbouring countries
...
// console.log(
//   `${myCountry.country} has ${myCountry.population} billion ${myCountry.language} - speaking people, ${myCountry.neighbours.length} neighbouring countries are ${myCountry.neighbours} and our country's capital is called ${myCountry.capital}.`
// );
...
const myCountry = {
  ...
  describe: function () {
    console.log(
      `${this.country} has ${this.population} billion ${this.language} - speaking people, ${this.neighbours.length} neighbouring countries are ${this.neighbours} and our country's capital is called ${this.capital}.`
    );
  },
...
// console.log(
//   "--------Assignment no. 11--------LECTURE: Looping Backwards and Loops in Loops"
// );
...
console.log(
  "--------Assignment no. 12--------LECTURE: Looping Backwards and Loops in Loops"
);
